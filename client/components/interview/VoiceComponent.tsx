...
export const VoiceComponent: React.FC<VoiceComponentProps> = ({ questionDescription }) => {
    const { isConnected, isSpeaking, startSession, stopSession, transcript } = useVapiInterview({ questionDescription });
