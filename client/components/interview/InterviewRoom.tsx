                ...
                <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800">
                    ...
                    <div className="flex-1 overflow-auto">
                        {activeTab === 'problem' ? (
                            ...
                            <VoiceComponent questionDescription={question.description} />
                        )}
                    </div>
                </div>
            </Panel>
            ...
            <Panel defaultSize={70}>
                <div className="flex flex-col h-full bg-[#1e1e1e]">
                    <div className="flex items-center justify-between px-4 py-2 bg-[#1e1e1e] border-b border-[#333]">
                        ...
                        <button className="px-4 py-1.5 bg-green-600 hover:bg-green-700 text-white text-xs font-semibold rounded transition-colors">
                            Submit Solution
                        </button>
                    </div>
